...
public class BasicListTester implements Runnable {
	...
	BasicListTester(int _numThr, List<Integer> _list) {
		numThr = _numThr;
		list = _list;
	 ...
	 * not in the list works. Copy this file and
	 * write additional tests as well!
